...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton:
                idle "images/UIMENU/Main menu/settings.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Main menu/settings_hover.png"  # Gambar untuk keadaan hover
                action ShowMenu("preferences")

            imagebutton:
                idle "gui/previous.png"  # Gambar untuk keadaan idle
                hover "gui/previous_hover.png"  # Gambar untuk keadaan hover
                action Rollback()
                xpos 1075
                ypos 600
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            imagebutton:
                idle "images/UIMENU/Main menu/new game.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Main menu/new game_hover.png"  # Gambar untuk keadaan hover
                action Start()

            imagebutton:
                idle "images/UIMENU/Main menu/continue.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Main menu/continue_hover.png"  # Gambar untuk keadaan hover
            ...
            imagebutton:
                idle "images/UIMENU/Settings/save.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Settings/save_hover.png"  # Gambar untuk keadaan hover
        ...
        if _in_replay:
            ...
            imagebutton:
                idle "images/UIMENU/Settings/main menu.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Settings/main menu_hover.png"  # Gambar untuk keadaan hover
                action MainMenu()

        imagebutton:
                idle "images/UIMENU/Main menu/about.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Main menu/about_hover.png"  # Gambar untuk keadaan hover
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            imagebutton:
                idle "images/UIMENU/Main menu/exit game.png"  # Gambar untuk keadaan idle
                hover "images/UIMENU/Main menu/exit game_hover.png"  # Gambar untuk keadaan hover
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    imagebutton:
                style "return_button"
                idle "gui/return.png"  # Gambar untuk keadaan idle
                hover "gui/return_hover.png"  # Gambar untuk keadaan hover
                action Return()

    if title not in ["Setting", "Tentang"]:
        frame:
            xpos 0.7
            ypos 0.1
            anchor (0.5, 0.5)

            # Gunakan logika kondisional untuk memilih gambar.
            if title == "Simpan":
                add "gui/archive.png"
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        xsize 415  # Lebar slot
                        ysize 240  # Tinggi slot
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        spacing 20
                        # style_prefix "radio"
                        add "images/UIMENU/Display.png"
                        hbox:
                            $ window_image = "gui/window select.png" if not _preferences.fullscreen else "gui/window.png"
                            $ window_hover_image = "gui/window select.png" if not _preferences.fullscreen else "gui/window.png"

                            imagebutton:
                                idle window_image  # Gambar idle diatur berdasarkan variabel
                                hover window_hover_image  # Gambar hover diatur berdasarkan variabel
                                action Preference("display", "window")
                        hbox:
                            $ fullscreen_image = "gui/full screen.png" if not _preferences.fullscreen else "gui/fullscreen select.png"
                            $ fullscreen_hover_image = "gui/full screen.png" if not _preferences.fullscreen else "gui/fullscreen select.png"
 
                            imagebutton:
                                idle fullscreen_image  # Gambar idle diatur berdasarkan variabel
                                hover fullscreen_hover_image  # Gambar hover diatur berdasarkan variabel
                                action Preference("display", "fullscreen")
                    
                    vbox:
                        spacing 20
                        # style_prefix "radio"
                        add "images/UIMENU/language.png"
                    
                        add "images/UIMENU/Indonesia.png"
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                imagebutton:
                    idle "gui/yes button.png"  # Gambar untuk keadaan idle
                    hover "gui/yes button.png"  # Gambar untuk keadaan hover
                    action yes_action
                imagebutton:
                    idle "gui/no button.png"  # Gambar untuk keadaan idle
                    hover "gui/no button.png"  # Gambar untuk keadaan hover
                    action no_action
